...
#
# Updates the CH list and then the Combined list
#
...
update_combined_sic_activites() {

    local javascript_file=update_combined_sic_activites.js
    ...
    echo "Updating combined collection in ${SIC_CODE_API_DATABASE} database"
